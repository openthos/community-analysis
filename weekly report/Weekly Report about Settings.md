...
## 曾非非
### 本周总结: 
       - 工作简述：1.回收站增加右键菜单还原／删除／全部还原／全部清空
                  2.回收站还原功能通过数据库存储路径，实现功能。
                  3.测试settings模块，并将测试结果反馈给测试组。
                  4.在github userguid模块编写openthos用户手册，并提交以制作gitbook.
                  5.测试openthos的user版本，并将测试结果反馈测试组。
                  6.与测试沟通是否更换OTA升级logo，测试已告知美工制作logo待更换。
