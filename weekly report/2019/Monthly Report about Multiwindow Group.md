...
### 罗浩
  - 1.完成android10窗口停靠功能的记忆
  - 2.整理高斯模糊原有内容
  - 3.高斯模糊适配兼容模式
  - 4.完成os2act报告
  - 5.完成高斯模糊api化，以计算器为例实现初步成功，并解决bug
  - 6.尝试statusbar全范围模糊成功，并解决bug
  - 7.调整模糊程度和色彩饱和度，提高模糊效果
  - 8.分析阴影问题的解决方案
...
### 罗浩
  - 1.完成10.0的emulator运行问题
  - 2.基本完成10.0应用启动流程中多窗口部分的分析和简单代码修改测试
  - 3.初步开发10.0的systemui功能
  - 4.解决微信切换兼容模式闪退的问题
  - 5.编译并成功运行用于pixelc的openthos8.1
