...
# 刘晓旭
  - 1.重构窗口标题栏UI，移除转屏、全屏功能按钮，增加窗口模式设置按钮，单击设置按钮，弹出运行模式选择列表（普通模式、全屏模式、强制手机模式-竖屏、强制手机模式-横屏），默认窗口普通模式下运行，普通模式选项高亮。已完成未提交
  - 2.窗口运行模式列表，单击四种模式，切换运行模式，目前基本实现普通模式、全屏模式之间互相切换，下一步实现强制手机模式-横、竖屏切换功能。
