...
| STATUS_BAR窗口可以自行决定blur的区域大小，目前认为可以用在startupMenu中，若未设定则surfaceflinger中会按照全layer都算作blur区域来计算  |              | 完成 | 20200309-20200313|
| 解决通知中心背景透明和模糊在发生动画时的时机冲突问题  |              | 完成 | 20200309-20200313|
