...
### 本周总结
  - 工作简述：
    - 1.优化云服务壁纸同步：当导入不成功时，桌面改为默认壁纸 。完成100%
    - 2.优化云服务任务栏同步：当导入锁定应用之前，把当前已锁定的应用清除。 完成100%
  - 新增任务
    - 1.解决Bug1112:以太网设置中切换模式可能会出现“设置无响应“ 或者是 “系统界面已停止运行“ 的错误。 完成100％
    
### 下周任务
  - 1.解决Bug:excel改字体大小时光标经常到FX处。
 
## 曹永韧
### 本周总结
  - 工作简述：
   - 1.解决锁定屏幕失效和锁定屏幕后任务栏出现问题。　--100%
   - 2.解决ppt右上角最大化和最小化功能失效问题.(陈鹏协助)　--70%
   - 3.解决卸载应用后，任务栏图标没有消失。　-- 100%
   
### 新增任务
  - 卸载应用后，任务栏图标没有消失。　
  
### 下周任务
  - 1.完全解决ＰＰＴ右上角最大化和最小化功能缺失问题。
  - 2.解决锁定后重启，锁定状态，进行解锁出现任务栏.
...
### 下周任务
  ...
  - 2. 弹出菜单在窗口外,共性问题。如：FM窗口还原状态下在左上角，右键弹出菜单位置正常；当FM窗口在右下角时弹出菜单位置不正常；微信是右下角正常，其他位置均不正常（董鹏3-3）
...
### 本周总结
  - 工作简述：
    - 1.[bug]: 更换以太网的图标。完成100%
    - 2.[bug]: 解决锁定屏幕失效和锁定屏幕后任务栏出现问题。完成70%
  
### 下周任务
  - 1.完全解决锁定屏幕失效和锁定屏幕后任务栏出现问题.
  - 2.解决ppt右上角最大化和最小化功能失效问题.(陈鹏协助)
  
...
### 本周总结
  - 工作简述：
    - 1.解决bug：通知栏进行点击操作时，会穿透到下层应用（穿透的bug）。完成100%
    - 2.[feature]设置云服务静态壁纸模块支持导入、导出功能 。完成100%
    
### 下周任务
  - 1.[feature]设置云服务其他模块支持导入、导出功能
