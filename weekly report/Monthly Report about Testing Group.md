...
- 修复自动编译、安装、运行的测试脚本
- 编写本地代码与github是否同步的脚本
- 简历筛选与测试工程师面试
- 编写mixer的测试用例，测试HZW对mixer的探索
- 补丁测试、亚克力效果测试、媒体播放器测试
...
- 发布oto8 user版镜像
- 测试集成到oto8里的Linux命令，测试openthos cloud桌面端
- 搭建自动化测试：阅读代码，重新实现，开始定期执行
- 简历筛选
- 调研可运行最新android的arm开发板
