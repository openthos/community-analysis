...
[**bug**]适用菜单不恰当，以前给陈老师的邮件发的word文件里就提过。菜单应考虑环境上下文，举例1：在回收站内文件上右键应是“还原/剪切/删除/属性”，而我们现在的却是“/打开/打开方式/复制/剪切/删除/永久删除/重命名/发送/复制路径/压缩/解压缩/详情”。举例2：非常压缩文件右键不应出现“解压”菜单项

[**bug**]右键菜单在非全屏时，离光标太远，应跟随光标，当然这个问题需要评估是由文件管理器造成的还是framework造成的。
...
# 桌面：
### 重要
[***bug***]桌面右键无法删除文档，delet可以(*实测delete不能删除，右键能删除*)  
...
# 开始菜单  
[**bug**]无鼠标滚轮时，如应用数量超过一屏，不方便使用。 

[**unhappy**]开始菜单字号太小，看着特别费劲。
# Firefox ：
### 重要
