...
# 文件管理器：
### 重要
[ bug 1107 ] 文件管理器个人空间中，文件夹被点击时，四个角会闪一下 

[ bug 1109 ] 文件管理器，双击没有扩展名的文件，弹出的菜单总是出现在左上角

[ bug 1113 ] 文件以图标模式显示时，选中文件，无法查看到全名。
...
[1102] 设置中配置以太网静态IP的排版有问题    

[1101] 无法通过蓝牙接收文件

[1100] 进入关于设备 ->法律信息，之后双击退回按钮，界面异常

[1099] 语言设置的倒数第六个选项无法正常显示

[1098] 无法设置电源管理中的节能模式

[1097] 使用快图选择壁纸，应用壁纸后，实际壁纸的尺寸与之前预览的不一致，实际的要大很多

[1096] 用快图选择壁纸时，第二次进入选项时会直接进入之前打开的文件夹

[1095] 设置字号为超大时，多项应用不能正常显示

[1094] 壁纸来源中有两个‘壁纸‘选项，且最后一个壁纸选项包含动态壁纸和普通图片，建议分别与其它选项合并

[1093] 部分应用的运行模式没有置灰

[bug 1104]电源按钮即时锁定功能无效

[1103] 打开VPN时会有“请插入sim卡“的提示一闪而过
