...
1.无法升级，升级之后消息，微信顶端会下沉

2.小视频无法播放

3.朋友圈评论时，只能输入文字，插入表情点击不可用

4.朋友圈内容显示不全，有时候显示不全。

5.红包，时显示金额，时而不显示金额，有时候无法显示最佳手气。

6.win客户端可以同步，我们不能同步

7.消息无法撤回（有的版本是这样的，有的版本不这样）

8.视频聊天的时候，窗口显示不正常，有时候闪退

9.点击联系人，右上角更多中的添加到桌面功能不可用
...
4.qq打开链接（总是在内部打开，不是外链）

5.qq用二维码传送文件，点开二维码后退出qq崩溃

6.切换夜间模式，QQ退出

7.空间发过的动态无法删除

8.之前用户手册写空间视频无法播放，测试20161229版本时，可以播放视频
