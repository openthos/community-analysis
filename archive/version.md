...
## 修复问题
 ...
 - 设置多窗口不包含浮动窗口
 - PackageInstaller：设置安装程序窗口不浮

# 20171222版本(包含1221patch）

## 修复问题

 - 解决UserSetupActivity警告对话框大小改变的问题
 - 修改设置对话框的窗口没有标题和弹出框没有插图的问题
 - 优化OtoLauncher性能
 - OtoOta：修改文字，添加改变下载的地址
 - 设置：阻止设置中的设备信息功能
...
## 修复问题
 ...
 - 键盘映射支持保存和加载键盘映射配置
 - 键盘映射支持调整轮盘比例
 - 解决phonewindow：支持鼠标事件时，控制打开MS Excel、Word、PowerPoint”的问题
...
## 修复问题
  ...
  - 解决学堂在线视频播放界面正确的问题
  - 解决学堂在线的ncourseintroduceactivity正确的问题
  - 解决学堂在线桌面显示正确的问题
...
## 修复问题
  ...
  - 解决在home页面中全部搜索
  - 解决确保acitvitystack不空转换倾向
  - 解决OtoLauncher清理代码的问题
...
## 修复问题
  ...
  - 解决新增支持通过relayoutwindow取向变化问题
  - 解决优化usersetupactivity代码和删除冗余代码问题
  - 解决开始菜单清理代码问题
...
## 修复问题
  ...
  - 解决otolauncher：优化代码,支持复制、粘贴、剪切，选择所有的文件,通过鼠标操作选择文件的问题
  - 解决framework/base:1。当关闭/重启键，禁止。2。设置默认在PowersourceActivity获得焦点。三.避免使用遍历过程，降低性能
...
## 修复问题
  ...
  - 解决在otosetupwizard ListView显示WiFi滚动条
