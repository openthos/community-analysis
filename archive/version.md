...
- 由于官网地址改变，云服务地址改为cloud.openthos.com；openthos浏览器首页改为hh
ttps://www.openthos.com
- 修复最新版微信聊天页面白屏问题
- 修复云服务的目录无法删除到回收站的问题
- 修复在桌面删除文件到回收站再还原后图标不会立即显示的问题
- 预装应用：由于大部分用户无法登录google帐号，预装应用删除日历；删除安卓x86上
不常用的onenote;更新微信等第三方应用
