...
- **注意：由于新增的云服务目录quota功能需要格式化data分区，此版本安装时会直接格式化data分区，不会提示用户是否格式化；且之前的版本无法升级到20190129之后的版本，其它版本间可以进行升级。此版本供大家试用，后续我们会优化这两个问题**
## 新增功能
...
# 20190110版本(包含20181124-20190109patch）
- **注意：由于新增的云服务目录quota功能需要格式化data分区，新版本安装时会直接格式化data分区，不会再提示用户是否格式化**
