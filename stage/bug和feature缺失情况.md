...
4. [bug 1023] excel调整比例100%后，保存关闭再次打开时仍为原大小，未保存设置(调研如何保存设置 ) 	---------arm版对比 (?陈刚)
5. [bug 1068] excel中无法插入批注---------arm版对比 （?陈刚）
6. [bug 1167] Excel单元格填充功能有问题，拖动右下角时不能正确填充---------arm版对比 （?陈刚）
...
2. [bug 1223] 点击格式化SD卡，openthos系统重启（？王之旭）
