...
**总结：1、聊天消息均只能长按复制，不能选择部分文字；<br>2、以上测试中，openthos的qq是应用商店中下载安装的，版本为6.3.7，若下载最新的6.7.0版本，则聊天消息无法复制；微信版本为6.3.18,与最新的6.5.6在复制粘贴情况上一致；<br>3、凤凰、技德均支持输入框中的右键菜单，openthos需长按显示菜单**
