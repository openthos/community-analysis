...
5. [bug 1068]excel中无法插入批注---------对比：手机上可以正常插入批注 （?陈刚）
...
**总结：<br>1、聊天消息均只能长按复制，不能选择部分文字；<br>2、以上测试中，openthos的qq是应用商店中下载安装的,微信版本为6.3.18,与最新的6.5.7在复制粘贴情况上一致；<br>3、凤凰、技德均支持输入框中的右键菜单，openthos需长按显示菜单**
